...
model_file = "Orenguteng/Llama-3-8B-Lexi-Uncensored-GGUF" # this is the specific model file we'll use in this example. It's a 4-bit quant, but other levels of quantization are available in the model repo if preferred
